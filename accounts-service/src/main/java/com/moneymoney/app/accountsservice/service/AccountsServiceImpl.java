...
public class AccountsServiceImpl implements AccountsService {
	...
	@Override
	public void updateBalance(Integer accountNumber, Double currentBalance) {
		Optional<Accounts> account = getAccountById(accountNumber);
		account.get().setCurrentBalance(currentBalance);
